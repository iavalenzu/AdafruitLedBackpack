...
{
    /// <summary>
    /// A AdafruitLedBackpack module for Microsoft .NET Gadgeteer
    /// </summary>
    public class AdafruitLedBackpack : GTM.Module
    {
        ...
        private Adafruit_BicolorMatrix matrix;
        ...
        // GTM.Efelunte.AdafruitLedBackpack. This file will provide IntelliSense and documentation for the
        // interface and make it easier for developers to use the AdafruitLedBackpack module.        
        ...
        public AdafruitLedBackpack(int socketNumber)
        {
             ...
             * INFO
             * 
             * I2C interface. Pins 8 and 9 are the dedicated I2C data (SDA) and clock (SCL) lines. 
             * Note that a mainboard should include pull-up resistors for these pins, in the region of 2.2K Ohms. 
             * Modules must not include their own pull-ups on these lines. In addition, pins 3 and 6 are 
             * general-purpose input/outputs, with pin 3 supporting interrupt capabilities.
            */

            matrix = new Adafruit_BicolorMatrix(socket);
            matrix.begin();
        ...
        /// <summary>
        /// Gets a value that indicates whether the button of the AdafruitLedBackpack is pressed.
        /// </summary>
        ...
        /// <summary>
        /// Represents the state of button of the <see cref="AdafruitLedBackpack"/>.
        /// </summary>
        ...
        /// </summary>
        /// <param name="sender">The <see cref="AdafruitLedBackpack"/> object that raised the event.</param>
        /// <param name="state">The state of the button of the <see cref="AdafruitLedBackpack"/></param>
        public delegate void ButtonEventHandler(AdafruitLedBackpack sender, ButtonState state);

        /// <summary>
        /// Raised when the button of the <see cref="AdafruitLedBackpack"/> is pressed.
        /// </summary>
        /// <remarks>
        ...
        /// <summary>
        /// Raised when the button of the <see cref="AdafruitLedBackpack"/> is released.
        /// </summary>
        /// <remarks>
        ...
        /// </summary>
        /// <param name="sender">The <see cref="AdafruitLedBackpack"/> that raised the event.</param>
        /// <param name="buttonState">The state of the button.</param>
        protected virtual void OnButtonEvent(AdafruitLedBackpack sender, ButtonState buttonState)
        {
